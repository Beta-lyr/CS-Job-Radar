        ...
        <div className="container" style={{ display: "grid", gap: 18 }}>
          ...
          <MethodPanel
            ...
            content={[
              ...
              "当前覆盖 6 个方向：Java 后端、Go 后端、前端开发、Android 开发、AI 应用开发、测试开发。",
              "部分跨方向岗位（如全栈、算法工程师）未被纳入当前分类体系。",
            ]}
          />
          <MethodPanel
            number={3}
            title="城市范围"
            content={[
              "核心覆盖 5 个城市：北京、上海、深圳、杭州、广州。",
              "其他城市的岗位样本量较少，暂未纳入分析，后续视数据量扩展。",
            ]}
          />
          <MethodPanel
            number={4}
